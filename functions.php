...
{
    /* Register styles */
    wp_register_style('themeName-style', get_template_directory_uri() . '/assets/dist/css/style.css', array(), '1.0', 'all');
...
{
    /* Register scripts */
    wp_register_script('themeName-script', get_template_directory_uri() . '/assets/dist/js/app.js', array('jquery'), '1.0', true);
